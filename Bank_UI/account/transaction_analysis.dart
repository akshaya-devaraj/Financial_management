          ...
          children: [
            Padding(
              ...
              child: GestureDetector(
                ...
                child: const Icon(Icons.arrow_back_ios, color: Color.fromARGB(255,30,60,100)),
              ),
            ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(
                    height: 45,
                    child: VerticalDivider(color: Color.fromARGB(255,30,60,100)),
                  ),
                  ...
                  lineBarsData: [
                    LineChartBarData(
                      ...
                      belowBarData: BarAreaData(
                        show: true,
                        color: Color.fromARGB(255,30,60,100).withOpacity(0.3),
                      ),
                    ),
                  ],
                      ...
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (value, _) => Text(
                          ...
                          style: const TextStyle(
                              color: Color.fromARGB(255,30,60,100), fontSize: 12),
                        ),
                      ),
                    ),
  ...
  Widget amountColumn(String title, double amount) {
    return Column(
      children: [
        Text(
          title,
          style: const TextStyle(fontSize: 18, color: Color.fromARGB(255,30,60,100)),
        ),
        Text(
          "₹${amount.toStringAsFixed(2)}",
          style: const TextStyle(
              fontSize: 32, color: Color.fromARGB(255,30,60,100), fontWeight: FontWeight.bold),
        ),
      ],
    );
  }
